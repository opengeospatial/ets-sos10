package org.opengis.cite.sos10;
...
public class TestRunArguments {
    ...
    public static Properties validateArguments(Document testRunArgs) {
        ...
        String capabilitiesUrl = args.getProperty(SOS10.SERVICE_URL);
        try {
            ...
            throw new IllegalArgumentException(String.format("Missing required argument: %s", SOS10.SERVICE_URL));
        }
        args.setProperty(SOS10.WHICH_TESTS, "all");
        return args;
    }
